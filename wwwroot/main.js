...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(authService, router, alertity) {
...
/***/ "./src/app/_guards/prevent-unsaved-changes.gaurd.ts":
/*!**********************************************************!*\
  !*** ./src/app/_guards/prevent-unsaved-changes.gaurd.ts ***!
  \**********************************************************/
...
var MemberEditResolver = /** @class */ (function () {
    ...
    MemberEditResolver = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            _services_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"], _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"]])
    ], MemberEditResolver);
    ...
    ErrorInterceptor.prototype.intercept = function (req, next) {
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
            if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpErrorResponse"]) {
                ...
                var applicationError = error.headers.get('Apllication-Error');
                if (applicationError) {
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(http, authService, alertify, router) {
        this.http = http;
        this.authService = authService;
        this.alertify = alertify;
        this.router = router;
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"],
...
var RegisterComponent = /** @class */ (function () {
    // registerMode = true;
    function RegisterComponent(authService, alertify, router) {
        this.authService = authService;
        this.alertify = alertify;
        this.router = router;
...
/* harmony import */ var _guards_prevent_unsaved_changes_gaurd__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./_guards/prevent-unsaved-changes.gaurd */ "./src/app/_guards/prevent-unsaved-changes.gaurd.ts");
    ...
    { path: '', component: _home_home_component__WEBPACK_IMPORTED_MODULE_0__["HomeComponent"] },
    {
        ...
        children: [
            ...
            { path: 'member/edit', component: _members_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_8__["MemberEditComponent"],
                resolve: { user: _resolvers_member_edit_resolver__WEBPACK_IMPORTED_MODULE_9__["MemberEditResolver"] }, canDeactivate: [_guards_prevent_unsaved_changes_gaurd__WEBPACK_IMPORTED_MODULE_10__["PreventUnsavedChanges"]] },
